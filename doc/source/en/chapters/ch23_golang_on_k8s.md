...
## Why Go is Great for K8s

| Feature | Benefit |
|---------|---------|
| Static binary | No runtime dependencies, `scratch` base image |
| Small image | ~10-15MB vs ~200MB+ for Java/Python |
| Fast startup | < 100ms cold start |
| Low memory | ~10-30MB per instance |
| Built-in concurrency | goroutines for high throughput |
| Signal handling | Clean graceful shutdown |
